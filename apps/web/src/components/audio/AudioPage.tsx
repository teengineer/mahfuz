...
import { MemorizationQuickAdd } from "./MemorizationQuickAdd";
    ...
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
      ...
      <div className="mb-6 flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-[var(--theme-border)] bg-[var(--theme-bg-secondary)] px-3 py-2 text-[13px] font-medium text-[var(--theme-text)] transition-colors hover:bg-[var(--theme-hover-bg)] flex-shrink-0"
        >
      ...
      {/* Memorization quick-add */}
      <MemorizationQuickAdd />
