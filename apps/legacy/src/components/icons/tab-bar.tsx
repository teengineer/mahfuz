...
export function TabBookIcon({ active }: TabIconProps) {
  if (active) {
    return (
...
export function TabGraduationIcon({ active }: TabIconProps) {
  if (active) {
    return (
      <svg className="h-6 w-6 text-primary-600" viewBox="0 0 24 24" fill="currentColor">
...
export function TabBrainIcon({ active }: TabIconProps) {
  if (active) {
    return (
      <svg className="h-6 w-6 text-primary-600" viewBox="0 0 24 24" fill="currentColor">
...
export function TabHeadphonesIcon({ active }: TabIconProps) {
  if (active) {
    return (
      <svg className="h-6 w-6 text-primary-600" viewBox="0 0 24 24" fill="currentColor">
...
export function TabSettingsIcon({ active }: TabIconProps) {
  if (active) {
    return (
      <svg className="h-6 w-6 text-primary-600" viewBox="0 0 24 24" fill="currentColor">
